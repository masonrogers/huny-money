 ...
 *
 * Phase 7 wires this up to live data via SWR. For now it accepts props so
 * the layout can be exercised.
 */
...
export function Header(props: HeaderProps) {
  ...
  return (
    <header className="surface-2 border-b border-x-0 border-t-0 px-6 py-3 flex items-center gap-4 flex-wrap">
      ...
      {props.modeChangePending && (
        <div className="ml-auto flex items-center gap-2 px-3 py-1.5 rounded-md border border-[var(--color-warning)]/40 bg-[var(--color-warning-bg)] text-[var(--color-warning)] text-xs font-medium">
          <StatusDot tone="warning" pulse />
